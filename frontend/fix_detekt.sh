...
while true; do
    ...
    echo "Fix the following issues:" | cat - <(sort /Users/boyd/wip/pocket_agent/frontend/app/build/reports/detekt/detekt.txt | head -10) | claude -p --verbose --output-format stream-json | jq -C
