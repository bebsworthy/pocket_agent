...
class WebSocketClientTest : BaseUnitTest() {
    ...
    @Test
    fun `connect establishes WebSocket connection`() =
        runTest {
            // Given
    ...
    @Test
    fun `sendMessage encodes and sends message`() =
        runTest {
            // Given
            val projectId = "test-project"
    ...
    @Test
    fun `receiveMessage decodes incoming message`() =
        runTest {
            // Given
            val projectId = "test-project"
    ...
    @Test
    fun `connection failure returns error result`() =
        runTest {
            // Given
    ...
    @Test
    fun `disconnect closes WebSocket connection`() =
        runTest {
            // Given
            val projectId = "test-project"
            val serverUrl = mockWebServer.url("/ws").toString()
    ...
    @Test
    fun `reconnection attempts with exponential backoff`() =
        runTest {
            // Given
            val projectId = "test-project"
            val serverUrl = mockWebServer.url("/ws").toString()
    ...
    @Test
    fun `message queuing during disconnection`() =
        runTest {
            // Given
            val projectId = "test-project"
    ...
    @Test
    fun `flush queued messages on reconnection`() =
        runTest {
            // Given
            val projectId = "test-project"
