 ...
 */
internal data class ProjectSetup(
...
internal data class ServerProfileEntity(
    val id: String,
    val name: String,
    val hostname: String,
    val port: Int,
...
internal data class BatteryStateEntity(
    val percentage: Int,
