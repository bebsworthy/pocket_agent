...
class NetworkConfigurationValidatorTest {
    ...
    fun `validateHostname should reject invalid IPv4 addresses`() {
        val invalidIpAddresses =
            listOf(
                ...
                "192.168.1",
                "192.168.1.1.1",
                // Leading zeros not technically invalid but not handled
                "192.168.01.1",
                "",
            )
    ...
    @Test
    fun `validateConfiguration should accept valid configuration`() =
        runTest {
    ...
    @Test
    fun `validateConfiguration should reject invalid hostname`() =
        runTest {
    ...
    @Test
    fun `validateConfiguration should reject invalid SSH port`() =
        runTest {
    ...
    @Test
    fun `validateConfiguration should reject invalid wrapper port`() =
        runTest {
    ...
    @Test
    fun `validateConfiguration should reject same ports`() =
        runTest {
    ...
    @Test
    fun `validateConfiguration should reject SSH port conflicts`() =
        runTest {
    ...
    @Test
    fun `validateConfiguration should reject wrapper port SSH conflict`() =
        runTest {
    ...
    @Test
    fun `canResolveHostname should handle localhost`() =
        runTest {
    ...
    @Test
    fun `canResolveHostname should handle invalid hostname`() =
        runTest {
    ...
    @Test
    fun `isPortReachable should handle unreachable port`() =
        runTest {
