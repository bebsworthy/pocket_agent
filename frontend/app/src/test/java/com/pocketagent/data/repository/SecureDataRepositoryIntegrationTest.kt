...
class SecureDataRepositoryIntegrationTest {
    ...
    @Test
    fun `end to end data persistence test`() =
        runTest {
    ...
    @Test
    fun `backup and restore functionality test`() =
        runTest {
    ...
    @Test
    fun `data validation and constraint enforcement test`() =
        runTest {
            repository.initialize()

            // Test SSH identity validation
            val invalidSshIdentity =
                SshIdentity(
                    id = "invalid-ssh-id",
                    // Invalid: empty name
                    name = "",
    ...
    @Test
    fun `export and import functionality test`() =
        runTest {
            repository.initialize()
    ...
    @Test
    fun `storage statistics and validation test`() =
        runTest {
            repository.initialize()
    ...
    @Test
    fun `concurrent access and thread safety test`() =
        runTest {
            repository.initialize()
