...
class MigrationIntegrationTest {
    ...
    @Test
    fun testRepositoryInitializationWithNewData() =
        runTest {
    ...
    @Test
    fun testRepositoryInitializationWithExistingCurrentData() =
        runTest {
    ...
    @Test
    fun testRepositoryInitializationWithOldData() =
        runTest {
    ...
    @Test
    fun testDataValidationAndRepair() =
        runTest {
            // Setup: Data with integrity issues
            val corruptedData =
                AppData(
                    version = 1,
                    // Missing SSH identity
                    ...
                    serverProfiles =
                        listOf(
                            com.pocketagent.data.models.ServerProfile(
                                ...
                                hostname = "test.com",
                                username = "user",
                                // References non-existent SSH identity
    ...
    @Test
    fun testMigrationStatusReporting() =
        runTest {
    ...
    @Test
    fun testMigrationBackupCreation() =
        runTest {
            // Setup: Existing data
            val testData =
                AppData(
    ...
    @Test
    fun testMigrationConfigurationApplication() =
        runTest {
            // Setup: Old data
            val oldData = AppData(version = 0)
            val jsonData = json.encodeToString(AppData.serializer(), oldData)
    ...
    @Test
    fun testMigrationProgressObservation() =
        runTest {
            // Setup: Old data
            val oldData = AppData(version = 0)
            val jsonData = json.encodeToString(AppData.serializer(), oldData)
