...
class ProjectServiceTest : BaseUnitTest() {
    ...
    @Test
    fun `createProject with valid data should succeed`() =
        runTest {
            // Given
            coEvery { mockRepository.getAllProjects() } returns emptyList()
    ...
    @Test
    fun `createProject with invalid server profile should fail`() =
        runTest {
            // Given
    ...
    @Test
    fun `createProject with validation failure should fail`() =
        runTest {
            // Given
    ...
    @Test
    fun `createProject with duplicate name should fail`() =
        runTest {
            // Given
    ...
    @Test
    fun `createProject with duplicate path on same server should fail`() =
        runTest {
            // Given
    ...
    @Test
    fun `createProject with maximum projects per server should fail`() =
        runTest {
            // Given
    ...
    @Test
    fun `createProject with invalid repository URL should fail`() =
        runTest {
            // Given
    ...
    @Test
    fun `getProject with valid ID should return project`() =
        runTest {
            // When
    ...
    @Test
    fun `getProject with invalid ID should fail`() =
        runTest {
            // Given
    ...
    @Test
    fun `updateProject with valid changes should succeed`() =
        runTest {
            // When
            val result =
    ...
    @Test
    fun `updateProject with non-existent project should fail`() =
        runTest {
            // Given
    ...
    @Test
    fun `updateProject with validation failure should fail`() =
        runTest {
            // Given
    ...
    @Test
    fun `updateProject with duplicate name should fail`() =
        runTest {
            // Given
    ...
    @Test
    fun `deleteProject with valid ID should succeed`() =
        runTest {
            // When
    ...
    @Test
    fun `deleteProject with non-existent project should fail`() =
        runTest {
            // Given
            coEvery { mockRepository.getProjectById("non-existent") } returns null
    ...
    @Test
    fun `deleteProject with active project should fail`() =
        runTest {
            // Given
    ...
    @Test
    fun `deleteProject without removing messages should not clear messages`() =
        runTest {
            // When
    ...
    @Test
    fun `listProjects with default parameters should return all projects`() =
        runTest {
            // Given
            val projects =
                listOf(
    ...
    @Test
    fun `listProjects with server filter should return filtered projects`() =
        runTest {
            // Given
            val projects =
                listOf(
    ...
    @Test
    fun `listProjects with status filter should return filtered projects`() =
        runTest {
            // Given
            val projects =
                listOf(
    ...
    @Test
    fun `updateProjectStatus to ACTIVE should succeed`() =
        runTest {
            // When
            val result =
    ...
    @Test
    fun `updateProjectStatus to ERROR should set error message`() =
        runTest {
            // When
            val result =
                projectService.updateProjectStatus(
    ...
    @Test
    fun `updateProjectStatus to INACTIVE should clear session`() =
        runTest {
            // Given
            val activeProject =
                testProject.copy(
    ...
    @Test
    fun `updateProjectStatus with invalid transition should fail`() =
        runTest {
            // Given
    ...
    @Test
    fun `activateProject should set project as active with session`() =
        runTest {
            // When
    ...
    @Test
    fun `deactivateProject should set project as inactive`() =
        runTest {
            // When
    ...
    @Test
    fun `markProjectAsError should set error status and message`() =
        runTest {
            // When
    ...
    @Test
    fun `clearProjectError should reset error state`() =
        runTest {
            // Given
            val errorProject =
                testProject.copy(
    ...
    @Test
    fun `searchProjects with matching query should return results`() =
        runTest {
            // Given
            val projects =
                listOf(
    ...
    @Test
    fun `searchProjects with empty query should return empty list`() =
        runTest {
            // When
    ...
    @Test
    fun `filterProjects with criteria should apply all filters`() =
        runTest {
            // Given
    ...
    @Test
    fun `getUsageStatistics should return stats for all projects`() =
        runTest {
            // Given
    ...
    @Test
    fun `getUsageStatistics with specific project IDs should return stats for those projects only`() =
        runTest {
            // Given
    ...
    @Test
    fun `exportProject should return JSON data`() =
        runTest {
            // When
    ...
    @Test
    fun `exportProject with non-existent project should fail`() =
        runTest {
            // Given
            coEvery { mockRepository.getProjectById("non-existent") } returns null
    ...
    @Test
    fun `importProject with valid JSON should create project`() =
        runTest {
            // Given
            val exportData =
                ProjectExport(
    ...
    @Test
    fun `importProject with server profile mapping should use mapped server`() =
        runTest {
            // Given
            val exportData =
                ProjectExport(
            ...
            coEvery { mockServerProfileService.getServerProfile("new-server") } returns
                Result.success(
    ...
    @Test
    fun `validation exceptions should be handled gracefully`() =
        runTest {
            // Given
