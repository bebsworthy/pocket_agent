...
class SshIdentityServiceTest {
    ...
    fun testCreateSshIdentity_Success() =
        runTest {
            // Arrange
    ...
    fun testCreateSshIdentity_InvalidKeyData() =
        runTest {
            // Arrange
    ...
    fun testCreateSshIdentity_DuplicateFingerprint() =
        runTest {
            // Arrange
            val existingIdentity =
                testSshIdentity.copy(
                    publicKeyFingerprint = "SHA256:testfingerprint123",
                )
    ...
    fun testCreateSshIdentity_ValidationFailure() =
        runTest {
            // Arrange
            every { sshKeyParser.parsePrivateKey(any(), any(), any()) } returns testKeyPair
            every { sshKeyEncryption.encryptPrivateKey(any()) } returns "encrypted_key_data"
            coEvery { repository.getAllSshIdentities() } returns emptyList()
            every { validator.validateForCreation(any()) } returns
    ...
    fun testGetSshIdentity_Success() =
        runTest {
            // Arrange
    ...
    fun testGetSshIdentity_NotFound() =
        runTest {
            // Arrange
    ...
    fun testUpdateSshIdentity_Success() =
        runTest {
            // Arrange
    ...
    fun testUpdateSshIdentity_NotFound() =
        runTest {
            // Arrange
            coEvery { repository.getSshIdentityById("non-existent") } returns null
    ...
    fun testDeleteSshIdentity_Success() =
        runTest {
            // Arrange
            coEvery { repository.getSshIdentityById("test-id") } returns testSshIdentity
    ...
    fun testDeleteSshIdentity_HasDependencies() =
        runTest {
            // Arrange
            coEvery { repository.getSshIdentityById("test-id") } returns testSshIdentity
    ...
    fun testListSshIdentities_Success() =
        runTest {
            // Arrange
            val identities =
                listOf(
    ...
    fun testSearchSshIdentities_ByName() =
        runTest {
            // Arrange
            val identities =
                listOf(
    ...
    fun testSearchSshIdentities_ByDescription() =
        runTest {
            // Arrange
            val identities =
                listOf(
    ...
    fun testFilterSshIdentities_RecentlyUsedOnly() =
        runTest {
            // Arrange
    ...
    fun testExportSshKey_PublicOnly() =
        runTest {
            // Arrange
            coEvery { repository.getSshIdentityById("test-id") } returns testSshIdentity
    ...
    fun testGenerateSshKey_Success() =
        runTest {
            // Arrange
    ...
    fun testValidateSshKey_Success() =
        runTest {
            // Arrange
    ...
    fun testGetUsageStatistics_Success() =
        runTest {
            // Arrange
            val serverProfiles =
                listOf(
    ...
    fun testRepositoryExceptionHandling() =
        runTest {
            // Arrange
    ...
    fun testEncryptionExceptionHandling() =
        runTest {
            // Arrange
            every { sshKeyParser.parsePrivateKey(any(), any(), any()) } returns testKeyPair
    ...
    private fun setupDefaultMocks() {
        ...
        every { java.security.MessageDigest.getInstance("SHA-256") } returns
            mockk {
                every { digest(any()) } returns "test_fingerprint_hash".toByteArray()
            }

        mockkStatic("java.util.Base64")
        every { java.util.Base64.getEncoder() } returns
            mockk {
