...
class ServerProfileServiceIntegrationTest {
    ...
    fun setup() {
        ...
        mockEncryptedStorage =
            mockk {
                ...
                every { getStorageStats() } returns
                    mockk {
                        every { isValid } returns true
                        every { totalSize } returns 0L
                        every { fileCount } returns 0
                    }
                coEvery { validateStorage() } returns
                    mockk {
                        every { isValid } returns true
                    }
            }
    ...
    @Test
    fun `full CRUD workflow should work correctly`() =
        runTest {
    ...
    @Test
    fun `validation workflow should work correctly`() =
        runTest {
            // Initialize repository
            repository.initialize()
    ...
    @Test
    fun `network validation should work correctly`() =
        runTest {
    ...
    @Test
    fun `filtering and sorting should work correctly`() =
        runTest {
