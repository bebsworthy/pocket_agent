...
class MigrationSystemTest {
    ...
    @Test
    fun testMigrationRegistryBasicOperations() = runTest {
    ...
    @Test
    fun testMigrationRegistryDuplicateRegistration() = runTest {
    ...
    @Test
    fun testMigrationPathFinding() = runTest {
    ...
    @Test
    fun testInitialMigrationExecution() = runTest {
        val migration = InitialMigration()
    ...
    fun testDataRepairMigration() = runTest {
        ...
        val orphanedServerProfile = ServerProfile(
            id = "server-1",
            name = "Orphaned Server",
            hostname = "orphaned.com",
            username = "user",
            sshIdentityId = "non-existent-ssh" // This SSH identity doesn't exist
        )
        
        val validServerProfile = ServerProfile(
            id = "server-2",
            name = "Valid Server",
            hostname = "valid.com",
            username = "user",
        ...
        val orphanedProject = Project(
            id = "project-1",
            name = "Orphaned Project",
            projectPath = "/path",
            serverProfileId = "non-existent-server" // This server doesn't exist
        )
        ...
        val corruptedData = AppData(
            version = 1,
            sshIdentities = listOf(validSshIdentity), // orphanedSshIdentity is not included
            ...
            messages = mapOf(
                ...
                "non-existent-project" to emptyList() // Orphaned messages
            )
        )
    ...
    @Test
    fun testMigrationManagerMigrationDetection() = runTest {
    ...
    @Test
    fun testMigrationProgressReporting() = runTest {
    ...
    @Test
    fun testMigrationValidationFailure() = runTest {
    ...
    @Test
    fun testMigrationManagerBackupCreation() = runTest {
        // Setup mocks
    ...
    @Test
    fun testMigrationHistoryLogging() = runTest {
        // Setup mocks
