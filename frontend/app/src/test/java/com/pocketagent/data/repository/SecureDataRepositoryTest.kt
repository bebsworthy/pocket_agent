...
class SecureDataRepositoryTest {
    ...
    fun setup() {
        ...
        coEvery { mockEncryptedStorage.getStorageStats() } returns mockk {
        ...
        coEvery { mockEncryptedStorage.validateStorage() } returns mockk {
    ...
    @Test
    fun `initialize should load existing data when available`() = runTest {
        // Given
    ...
    @Test
    fun `initialize should create empty data when no existing data`() = runTest {
        // Given
    ...
    @Test
    fun `addSshIdentity should add new identity successfully`() = runTest {
        // Given
        repository.initialize()
    ...
    @Test
    fun `addSshIdentity should throw exception for duplicate name`() = runTest {
        // Given
        repository.initialize()
    ...
    @Test
    fun `updateSshIdentity should update existing identity`() = runTest {
        // Given
        repository.initialize()
    ...
    @Test
    fun `updateSshIdentity should throw exception for non-existent identity`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
    ...
    @Test
    fun `deleteSshIdentity should remove identity successfully`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
        repository.addSshIdentity(identity)
    ...
    @Test
    fun `deleteSshIdentity should throw exception when identity is in use`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
    ...
    @Test
    fun `addServerProfile should add new profile successfully`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
    ...
    @Test
    fun `addServerProfile should throw exception when SSH identity not found`() = runTest {
        // Given
        repository.initialize()
    ...
    @Test
    fun `deleteServerProfile should throw exception when profile is in use`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
        val profile = createTestServerProfile(sshIdentityId = identity.id)
    ...
    @Test
    fun `addProject should add new project successfully`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
        val profile = createTestServerProfile(sshIdentityId = identity.id)
    ...
    @Test
    fun `addProject should throw exception when server profile not found`() = runTest {
        // Given
        repository.initialize()
    ...
    @Test
    fun `deleteProject should remove project and its messages`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
        val profile = createTestServerProfile(sshIdentityId = identity.id)
    ...
    @Test
    fun `addMessage should add message to project`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
        val profile = createTestServerProfile(sshIdentityId = identity.id)
    ...
    @Test
    fun `addMessage should limit messages per project`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
        val profile = createTestServerProfile(sshIdentityId = identity.id)
    ...
    @Test
    fun `getProjectsForServer should return projects for specific server`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
    ...
    @Test
    fun `observeProjects should emit updates when projects change`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
        val profile = createTestServerProfile(sshIdentityId = identity.id)
    ...
    @Test
    fun `exportData should return JSON representation of data`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
        repository.addSshIdentity(identity)
    ...
    @Test
    fun `importData should load data from JSON`() = runTest {
        // Given
        repository.initialize()
    ...
    @Test
    fun `createBackup should return backup filename`() = runTest {
        // Given
        repository.initialize()
    ...
    @Test
    fun `restoreBackup should restore data and reinitialize`() = runTest {
        // Given
        repository.initialize()
    ...
    @Test
    fun `clearAllData should remove all data`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
        repository.addSshIdentity(identity)
    ...
    @Test
    fun `getDataSummary should return correct statistics`() = runTest {
        // Given
        repository.initialize()
        val identity = createTestSshIdentity()
        val profile = createTestServerProfile(sshIdentityId = identity.id)
