...
class MigrationWorkflowTest {
    ...
    @Test
    fun testCompleteNewUserWorkflow() =
        runTest {
    ...
    @Test
    fun testExistingUserUpgradeWorkflow() =
        runTest {
    ...
    @Test
    fun testDataCorruptionDetectionAndRepairWorkflow() =
        runTest {
                    ...
                    projects =
                        listOf(
                            ...
                            Project(
                                ...
                                serverProfileId = "missing-server",
                            ),
                        ),
                )
    ...
    fun testBackupAndRestoreWorkflow() =
        runTest {
            ...
            val backupResult =
                migrationHelper.createDataBackup(
            ...
            val restoreResult =
                repository.restoreFromMigrationBackup(
                    migrationManager = migrationManager,
    ...
    @Test
    fun testProgressReportingWorkflow() =
        runTest {
            ...
            val summary =
                migrationHelper.initializeRepositoryWithMigration(repository) { progress ->
    ...
    @Test
    fun testMigrationFailureAndRecoveryWorkflow() =
        runTest {
    ...
    @Test
    fun testMigrationStatusMonitoringWorkflow() =
        runTest {
            ...
            val historyJson =
                json.encodeToString<List<MigrationLogEntry>>(
                    listOf(
                        MigrationLogEntry(
                            // 1 day ago
