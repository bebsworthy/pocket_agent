...
class ProjectServiceIntegrationTest : BaseUnitTest() {
    ...
    @Test
    fun `complete project lifecycle - create, update, activate, deactivate, delete`() = runTest {
        // Test project data
        ...
        // 1. Create Project
        val createResult = projectService.createProject(
            name = projectName,
        ...
        val updateResult = projectService.updateProject(
    ...
    @Test
    fun `project error handling and recovery workflow`() = runTest {
        // Create a project
        val createResult = projectService.createProject(
    ...
    @Test
    fun `project search and filtering integration`() = runTest {
        ...
        val filterResult = projectService.filterProjects(
        ...
        val statusFilterResult = projectService.filterProjects(
        ...
        val repoFilterResult = projectService.filterProjects(
        ...
        val complexFilterResult = projectService.filterProjects(
    ...
    @Test
    fun `project import and export workflow`() = runTest {
    ...
    @Test
    fun `project usage statistics tracking`() = runTest {
    ...
    @Test
    fun `project validation and constraint enforcement`() = runTest {
        ...
        val duplicateNameResult = projectService.createProject(
            name = "Existing Project",
            serverProfileId = testServerId,
        ...
        val duplicatePathResult = projectService.createProject(
            name = "Different Name",
            serverProfileId = testServerId,
            projectPath = "/home/user/existing"
        )
        ...
        val limitResult = projectService.createProject(
