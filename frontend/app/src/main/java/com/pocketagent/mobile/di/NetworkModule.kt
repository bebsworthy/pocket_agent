...
abstract class NetworkModule {
    ...
    @Binds
    @Singleton
    abstract fun bindWebSocketConnectionManager(
        impl: WebSocketConnectionManagerImpl
    ...
    @Binds
    @Singleton
    abstract fun bindConnectionHealthMonitor(
        impl: ConnectionHealthMonitorImpl
