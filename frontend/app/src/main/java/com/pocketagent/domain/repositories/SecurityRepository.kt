...
interface SecurityRepository {
     ...
     */
    suspend fun decryptData(encryptedData: ByteArray, keyAlias: String): Result<ByteArray>
...
sealed class CertificateValidationResult {
    ...
    data class RequiresUserApproval(val certificateData: ByteArray) : CertificateValidationResult()
}
