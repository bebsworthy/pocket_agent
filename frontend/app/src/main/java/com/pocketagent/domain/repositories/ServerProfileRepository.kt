...
interface ServerProfileRepository {
     ...
     * @return The updated server profile
     */
    suspend fun updateConnectionStatus(id: String, status: ConnectionStatus): Result<ServerProfile>
     ...
     */
    suspend fun validatePort(hostname: String, port: Int): Result<Boolean>
     ...
     */
    suspend fun duplicateProfile(id: String, newName: String): Result<ServerProfile>
