...
interface CommunicationRepository {
     ...
     */
    suspend fun connect(projectId: String, serverProfileId: String): Result<Unit>
     ...
     * @return Success or error result
     */
    suspend fun reconnect(projectId: String, maxRetries: Int = 3): Result<Unit>
     ...
     * @return Success or error result
     */
    suspend fun disconnect(projectId: String, shutdown: Boolean = false): Result<Unit>
     ...
     * @return Success or error result
     */
    suspend fun sendMessage(projectId: String, message: String): Result<Unit>
     ...
     * @return Success or error result
     */
    suspend fun sendCommand(projectId: String, command: String): Result<Unit>
     ...
     */
    suspend fun sendFileDownload(projectId: String, filePath: String): Result<ByteArray>
     ...
     * @return Success or error result
     */
    suspend fun setAutoReconnect(projectId: String, enabled: Boolean): Result<Unit>
