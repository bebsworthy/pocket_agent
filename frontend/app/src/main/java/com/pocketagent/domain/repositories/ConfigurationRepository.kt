...
data class AppSettings(
    ...
    val maxCacheSize: Long = SizeConstants.DEFAULT_MAX_CACHE_SIZE, // 100MB
    val maxLogSize: Long = SizeConstants.DEFAULT_MAX_LOG_SIZE, // 10MB
...
data class SecuritySettings(
    ...
    val sessionTimeoutMinutes: Int = TimeConstants.DEFAULT_SESSION_TIMEOUT_MINUTES,
    val autoLockEnabled: Boolean = true,
    val autoLockDelayMinutes: Int = TimeConstants.DEFAULT_AUTO_LOCK_DELAY_MINUTES,
    ...
    val keyRotationIntervalDays: Int = TimeConstants.DEFAULT_KEY_ROTATION_INTERVAL_DAYS,
...
data class CommunicationSettings(
    val connectionTimeoutSeconds: Int = NetworkConstants.DEFAULT_CONNECTION_TIMEOUT_SECONDS,
    val readTimeoutSeconds: Int = NetworkConstants.DEFAULT_READ_TIMEOUT_SECONDS,
    val writeTimeoutSeconds: Int = NetworkConstants.DEFAULT_WRITE_TIMEOUT_SECONDS,
    val keepAliveEnabled: Boolean = true,
    val keepAliveIntervalSeconds: Int = NetworkConstants.DEFAULT_KEEP_ALIVE_INTERVAL_SECONDS,
    val maxReconnectAttempts: Int = NetworkConstants.DEFAULT_MAX_RETRIES,
    val reconnectBackoffSeconds: Int = NetworkConstants.DEFAULT_RECONNECT_BACKOFF_SECONDS,
    val compressionEnabled: Boolean = true,
    val batchMessagesEnabled: Boolean = true,
    val maxBatchSize: Int = SizeConstants.DEFAULT_MAX_BATCH_SIZE,
    val messageQueueSize: Int = SizeConstants.DEFAULT_MESSAGE_QUEUE_SIZE,
    val heartbeatIntervalSeconds: Int = NetworkConstants.DEFAULT_HEARTBEAT_INTERVAL_SECONDS,
