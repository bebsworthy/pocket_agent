...
interface MessageRepository {
     ...
     */
    suspend fun saveMessage(projectId: String, message: Message): Result<Message>
     ...
     */
    suspend fun saveMessages(projectId: String, messages: List<Message>): Result<List<Message>>
     ...
     */
    suspend fun getRecentMessages(projectId: String, limit: Int = 20): Result<List<Message>>
     ...
     */
    suspend fun getUserMessages(projectId: String, limit: Int = 50): Result<List<Message>>
     ...
     */
    suspend fun getClaudeMessages(projectId: String, limit: Int = 50): Result<List<Message>>
     ...
     */
    suspend fun getSystemMessages(projectId: String, limit: Int = 50): Result<List<Message>>
     ...
     */
    suspend fun getErrorMessages(projectId: String, limit: Int = 50): Result<List<Message>>
     ...
     */
    suspend fun searchAllMessages(query: String, limit: Int = 20): Result<List<Message>>
     ...
     */
    suspend fun trimMessages(projectId: String, maxMessages: Int = 1000): Result<Int>
