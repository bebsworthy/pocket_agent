...
sealed class StorageException(message: String, cause: Throwable? = null) : Exception(message, cause) {
     ...
     */
    class EncryptionException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when file operations fail.
     */
    class FileOperationException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when data validation fails.
     */
    class ValidationException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when backup operations fail.
     */
    class BackupException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when storage configuration is invalid.
     */
    class ConfigurationException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when storage quota is exceeded.
     */
    class QuotaExceededException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when attempting to access non-existent data.
     */
    class DataNotFoundException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when data integrity checks fail.
     */
    class IntegrityException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when concurrent access conflicts occur.
     */
    class ConcurrencyException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when storage is in an inconsistent state.
     */
    class InconsistentStateException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when storage format is not supported.
     */
    class UnsupportedFormatException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when storage migration fails.
     */
    class MigrationException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when storage is locked or inaccessible.
     */
    class AccessDeniedException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when storage operations timeout.
     */
    class TimeoutException(message: String, cause: Throwable? = null) : StorageException(message, cause)
    
    /**
     * Exception thrown when storage is corrupted.
     */
    class CorruptionException(message: String, cause: Throwable? = null) : StorageException(message, cause)
}

/**
 * Error codes for storage operations.
 */
enum class StorageErrorCode(val code: String, val description: String) {
    // Encryption errors
    ...
    companion object {
        fun fromCode(code: String): StorageErrorCode? {
...
class DetailedStorageException(
     ...
     */
    fun withContext(key: String, value: Any): DetailedStorageException {
...
object StorageExceptionFactory {
     ...
     */
    fun encryptionFailed(message: String, cause: Throwable? = null, context: Map<String, Any> = emptyMap()): DetailedStorageException {
        return DetailedStorageException(
     ...
     */
    fun decryptionFailed(message: String, cause: Throwable? = null, context: Map<String, Any> = emptyMap()): DetailedStorageException {
        return DetailedStorageException(
     ...
     */
    fun fileOperationFailed(errorCode: StorageErrorCode, message: String, filename: String, cause: Throwable? = null): DetailedStorageException {
        return DetailedStorageException(
            errorCode = errorCode,
            message = message,
            cause = cause,
     ...
     */
    fun validationFailed(errorCode: StorageErrorCode, message: String, details: String? = null, cause: Throwable? = null): DetailedStorageException {
     ...
     */
    fun backupFailed(errorCode: StorageErrorCode, message: String, backupFile: String? = null, cause: Throwable? = null): DetailedStorageException {
        val context = mutableMapOf<String, Any>()
        if (backupFile != null) {
     ...
     */
    fun configurationError(message: String, configKey: String? = null, cause: Throwable? = null): DetailedStorageException {
        val context = mutableMapOf<String, Any>()
        if (configKey != null) {
     ...
     */
    fun quotaExceeded(errorCode: StorageErrorCode, message: String, currentSize: Long, maxSize: Long): DetailedStorageException {
        return DetailedStorageException(
            errorCode = errorCode,
            message = message,
            context = mapOf(
     ...
     */
    fun concurrencyError(message: String, resource: String? = null, cause: Throwable? = null): DetailedStorageException {
        val context = mutableMapOf<String, Any>()
        if (resource != null) {
     ...
     */
    fun accessDenied(message: String, resource: String? = null, requiredPermission: String? = null): DetailedStorageException {
        val context = mutableMapOf<String, Any>()
        if (resource != null) {
            context["resource"] = resource
        }
     ...
     */
    fun dataCorrupted(message: String, filename: String? = null, expectedChecksum: String? = null, actualChecksum: String? = null): DetailedStorageException {
        val context = mutableMapOf<String, Any>()
        if (filename != null) {
