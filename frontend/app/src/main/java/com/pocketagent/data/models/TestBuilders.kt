...
class DataScenarioBuilder {
     ...
     */
    fun addDevelopmentScenario(): DataScenarioBuilder = apply {
     ...
     */
    fun addEnterpriseScenario(): DataScenarioBuilder = apply {
     ...
     */
    fun addPersonalScenario(): DataScenarioBuilder = apply {
     ...
     */
    fun buildAppData(): AppData = AppData(
     ...
     */
    fun buildComponents(): DataComponents = DataComponents(
        sshIdentities = sshIdentities.toList(),
        serverProfiles = serverProfiles.toList(),
        projects = projects.toList(),
        messages = messages.toMap()
...
class RealisticSshIdentityBuilder {
    ...
    companion object {
         ...
         */
        fun createMultiple(count: Int): List<SshIdentity> = (1..count).map { index ->
            when (index % 3) {
...
class RealisticServerProfileBuilder {
    ...
    companion object {
         ...
         */
        fun createLocalhost(sshIdentityId: String, name: String = "Localhost"): ServerProfile = 
         ...
         */
        fun createCloud(sshIdentityId: String, name: String = "Cloud Server"): ServerProfile = 
            ServerProfileBuilder()
                .name(name)
         ...
         */
        fun createVPS(sshIdentityId: String, name: String = "VPS Server"): ServerProfile = 
            ServerProfileBuilder()
                .name(name)
         ...
         */
        fun createMultiple(count: Int, sshIdentityId: String): List<ServerProfile> = 
            (1..count).map { index ->
                when (index % 3) {
...
class RealisticProjectBuilder {
    ...
    companion object {
         ...
         */
        fun createWebApp(serverProfileId: String, name: String = "Web App"): Project = 
            ProjectBuilder()
                .name(name)
         ...
         */
        fun createMobileApp(serverProfileId: String, name: String = "Mobile App"): Project = 
            ProjectBuilder()
                .name(name)
                .serverProfileId(serverProfileId)
         ...
         */
        fun createBackendAPI(serverProfileId: String, name: String = "Backend API"): Project = 
            ProjectBuilder()
                .name(name)
                .serverProfileId(serverProfileId)
         ...
         */
        fun createMultiple(count: Int, serverProfileId: String): List<Project> = 
            (1..count).map { index ->
                when (index % 3) {
...
class RealisticMessageBuilder {
    ...
    companion object {
         ...
         */
        fun createDebuggingConversation(): List<Message> = listOf(
         ...
         */
        fun createCodeReviewConversation(): List<Message> = listOf(
         ...
         */
        fun createSetupConversation(): List<Message> = listOf(
         ...
         */
        fun createErrorConversation(): List<Message> = listOf(
...
object TestDataFactory {
     ...
     */
    fun createMinimalDataset(): AppData = DataScenarioBuilder()
     ...
     */
    fun createComprehensiveDataset(): AppData = DataScenarioBuilder()
    ...
    fun createDatasetWithCounts(
        ...
        return AppData(
            ...
            projects = projects,
            messages = projects.associate { project ->
