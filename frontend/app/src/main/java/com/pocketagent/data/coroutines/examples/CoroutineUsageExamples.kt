...
class ProjectViewModel @Inject constructor(
    ...
    private val _uiState = FlowConfiguration.createStateFlow(ProjectUiState.Loading)
     ...
     */
    fun createProject(name: String, serverProfileId: String, projectPath: String) {
        launchWithErrorHandling(
            onError = { throwable ->
...
class WebSocketService @Inject constructor(
    ...
    private val _connectionState = FlowConfiguration.createStateFlow(ConnectionState.Disconnected)
...
class CreateProjectUseCase @Inject constructor(
     ...
     */
    suspend fun execute(request: CreateProjectRequest): Result<Project> = withContext(dispatchers.default) {
        ErrorHandlingUtils.safeCall(
            onError = { throwable ->
                Result.failure(throwable)
            }
