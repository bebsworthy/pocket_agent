...
class MigrationRegistry @Inject constructor() {
     ...
     */
    suspend fun findMigration(fromVersion: Int, toVersion: Int): DataMigration? {
     ...
     */
    suspend fun findMigrationPath(fromVersion: Int, toVersion: Int): List<DataMigration> {
     ...
     */
    suspend fun hasMigrationPath(fromVersion: Int, toVersion: Int): Boolean {
     ...
     */
    private fun findUpgradePath(fromVersion: Int, toVersion: Int): List<DataMigration> {
        val path = mutableListOf<DataMigration>()
        var currentVersion = fromVersion
        
        while (currentVersion < toVersion) {
            // Find the next available migration
            val nextMigration = migrations.values
            ...
            if (nextMigration == null) {
                ...
                val anyMigration = migrations.values
     ...
     */
    private fun findDowngradePath(fromVersion: Int, toVersion: Int): List<DataMigration> {
        val path = mutableListOf<DataMigration>()
        var currentVersion = fromVersion
     ...
     */
    private fun hasDirectOrIndirectPath(fromVersion: Int, toVersion: Int): Boolean {
     ...
     */
    private fun hasPath(from: Int, to: Int, visited: MutableSet<Int>): Boolean {
     ...
     */
    private fun hasCircularDependency(from: Int, to: Int, visited: MutableSet<Pair<Int, Int>>): Boolean {
