...
class SshIdentityValidator
    ...
    constructor() {
         ...
         */
        fun validateFingerprintUniqueness(
            fingerprint: String,
            existingFingerprints: List<String>,
            excludeId: String? = null,
        ): ValidationResult {
            val conflictingFingerprints =
                existingFingerprints.filter { existingFingerprint ->
