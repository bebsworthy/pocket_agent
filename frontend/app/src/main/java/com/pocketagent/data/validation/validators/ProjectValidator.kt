...
class ProjectValidator @Inject constructor() {
        ...
        return ValidationRuleBuilder<String>()
            ...
            .addRule(
                { folder ->
                    ...
                    val reserved = listOf("system", "tmp", "temp", "cache", "logs", "config", "bin", "usr", "var", "etc")
    ...
    fun validateClaudeSessionId(claudeSessionId: String?): ValidationResult {
        return if (claudeSessionId == null) {
    ...
    fun validateBusinessRules(project: Project): ValidationResult {
        ...
        // Validate repository URL matches common patterns
        project.repositoryUrl?.let { url ->
            ...
            val isCommonProvider = commonPatterns.any { pattern ->
     ...
     */
    fun validateForUpdate(original: Project, updated: Project): ValidationResult {
     ...
     */
    fun validateStatusTransition(fromStatus: ProjectStatus, toStatus: ProjectStatus): ValidationResult {
    ...
    fun validateProjectPathUniqueness(
        ...
        val conflictingProjects = existingProjects.filter { (existingPath, existingServerId) ->
