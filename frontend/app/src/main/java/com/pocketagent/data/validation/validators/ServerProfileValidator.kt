    ...
    constructor() {
        ...
        fun validateStatusTransition(
            ...
            val validTransitions =
                mapOf(
                    ConnectionStatus.NEVER_CONNECTED to
                        setOf(
                            ConnectionStatus.CONNECTING,
                            ConnectionStatus.NEVER_CONNECTED,
                        ),
                    ...
                    ConnectionStatus.DISCONNECTED to
                        setOf(
                            ConnectionStatus.CONNECTING,
                            ConnectionStatus.CONNECTED,
                            ConnectionStatus.ERROR,
        ...
        fun validateHostnamePortUniqueness(
            ...
            val conflictingProfiles =
                existingProfiles.filter { (existingHostname, existingPort) ->
