...
const IconButton = React.forwardRef<HTMLButtonElement, IconButtonProps>(
  ({ className, icon, size = 'md', variant = 'ghost', onPress, disabled, ...props }, ref) => {
    ...
    const variants = {
      ghost:
        'hover:bg-gray-100 dark:hover:bg-gray-800 focus-visible:ring-gray-500 active:bg-gray-200 dark:active:bg-gray-700',
      solid:
        'bg-blue-600 text-white hover:bg-blue-700 focus-visible:ring-blue-500 active:bg-blue-800',
      outline:
        'border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 focus-visible:ring-gray-500',
    };
